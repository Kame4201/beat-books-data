...
class TeamDefenseCreate(BaseModel):
    ...
    nypa: Optional[Decimal] = Field(None, ge=0, description="Net yards per pass attempt allowed")
    firstd_pass: Optional[int] = Field(None, ge=0, description="First downs allowed via pass")
    ...
    firstd_rush: Optional[int] = Field(None, ge=0, description="First downs allowed via rush")
    ...
    firstpy: Optional[int] = Field(None, ge=0, description="First downs allowed via penalty")
    sc_pct: Optional[Decimal] = Field(None, ge=0, le=100, description="Scoring percentage allowed")
    to_pct: Optional[Decimal] = Field(None, ge=0, le=100, description="Turnover percentage forced")
    depa: Optional[Decimal] = Field(None, description="Defensive expected points allowed")
