"""
DTOs for kicking stats operations.
"""
...
class KickingStatsCreate(BaseModel):
    """DTO for creating kicking stats records."""
...
class KickingStatsResponse(KickingStatsCreate):
    """DTO for kicking stats response."""
