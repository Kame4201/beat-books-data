...
class InjuryReportCreate(BaseModel):
    ...
    player_name: str = Field(..., min_length=1, max_length=255, description="Player full name")
    team: str = Field(..., min_length=2, max_length=10, description="Team abbreviation")
    position: Optional[str] = Field(None, max_length=10, description="Player position (QB, RB, etc.)")
    designation: str = Field(..., description="Injury designation (Questionable/Doubtful/Out/IR)")
